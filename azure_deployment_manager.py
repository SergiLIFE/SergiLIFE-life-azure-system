...
class LifeAzureDeploymentManager:
    ...
    async def validate_azure_connection(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.info(f"✅ Subscription access confirmed: {subscription.display_name}")
            except Exception as e:
                logger.error(f"❌ Cannot access subscription {self.subscription_id}: {e}")
                return False
    ...
    async def create_resource_group(self) -> bool:
        ...
        try:
            logger.info(f"🏗️ Creating/verifying resource group: {self.resource_group_name}")
            ...
            try:
                ...
                logger.info(f"🆕 Creating new resource group: {self.resource_group_name}")
            ...
            container_config = {
                ...
                'containers': [{
                    ...
                    'environment_variables': [
                        {'name': 'LIFE_PLATFORM_VERSION', 'value': '2025.1.0-PRODUCTION'},
                        {'name': 'AZURE_MARKETPLACE_OFFER_ID', 'value': '9a600d96-fe1e-420b-902a-a0c42c561adb'},
    ...
    async def validate_deployment(self) -> Dict[str, Any]:
        ...
        try:
            ...
            validation_results['overall_status'] = 'ready' if readiness_score >= 90 else 'needs_attention'
            
            logger.info(f"✅ Deployment validation complete")
            logger.info(f"🎯 Launch readiness: {validation_results['launch_readiness']}%")
    ...
    async def full_deployment(self) -> bool:
        ...
        try:
            ...
            logger.info(f"📊 Launch readiness: {validation.get('launch_readiness', 0)}%")
