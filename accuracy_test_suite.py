...
class AccuracyTestSuite(unittest.TestCase):
    ...
    def _run_accuracy_test(self, test_name: str, actual_accuracy: float,
                          expected_minimum: float = 0.75) -> AccuracyTestResult:
