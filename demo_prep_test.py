"""Simple test to create demo preparation checklist"""
import os

# Create demo_prep directory
os.makedirs("demo_prep", exist_ok=True)
...
# Write to file
with open("demo_prep/demo_preparation_checklist.md", "w", encoding='utf-8') as f:
    f.write(checklist_content.strip())

print("🎯 Demo preparation checklist created successfully!")
print("📁 Location: demo_prep/demo_preparation_checklist.md")
print("📅 Ready for October 15, 2025 Google Meet demo!")