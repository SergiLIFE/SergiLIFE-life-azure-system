...
async def get_performance_metrics():
    ...
    try:
        metrics = {
            ...
            "neural_processing_rate_hz": int(os.getenv('NEURAL_PROCESSING_RATE', '1000')),
...
async def process_neural_data(data: Dict[str, Any]):
    ...
    if not optimizer:
        raise HTTPException(status_code=503, detail="Autonomous optimizer not available")
